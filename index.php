          ...
          <div class="container">
              <div class="row align-items-center justify-content-center text-center">
                  <div class="col-md-10">
                    ...
                    <p><a href="<?php echo URL("property-details.php?id=$prop[id]")?>" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 btn-2">See Details</a></p>
                  </div>
              </div>
          </div>
      </div> 
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="property-entry h-100">
                ...
                <div class="p-4 property-body">
                  ...
                  <h2 class="property-title"><a href="<?php echo URL("property-details.php?id=$prop[id]")?>">625 S. Berendo St</a></h2>
