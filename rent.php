<?php require_once "includes/header.php"?>
    ...
    <?php 
      ...
      // Getting properties that are For Rent
      $propsForRent = searchPropertiesByofferType('For Rent');

      // Slicing the array to show some props in the slider
      $propsForRentSlice = array_slice($propsForRent, 0, 4);

      // var_dump($propsForRent);
      //var_dump($propsForRentSlice);
    ...
    <?php 
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['search'])){
        ...
        $propsForRent = searchProperties($listingType, $offerType, $city);
    ...
    <?php 
      ...
      if (isset($_POST['sortBy'])) {
        ...
        if ($sortOrder) {
            $propsForRent = sortProperties($propsForRent, $sortOrder);
        }
      }
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <?php foreach($propsForRentSlice as $prop): ?>
          <div class="site-blocks-cover overlay" style="background-image: url(assets/uploads/properties/images/<?=$prop['image']?>);" data-aos="fade" data-stellar-background-ratio="0.5">
            <div class="container">
              <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                  <span class="d-inline-block bg-info text-dark px-3 mb-3 property-offer-type rounded">
      ...
      <div class="container">
        ...
        <div class="row mb-5">
            ...
            <?php else: ?>
                ...
                <?php foreach($propsForRent as $prop): ?>
                  <?php 
                    ...
                    <div class="property-entry h-100">
                      ...
                      >
                        <div class="offer-type-wrap">
                          <span class="offer-type bg-info text-dark">
                            <?=$prop['property_status']?>
                          </span>
                        </div>
